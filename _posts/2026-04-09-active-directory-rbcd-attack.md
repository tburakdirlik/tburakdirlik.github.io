---
title: "Privilege Escalation in Active Directory: Resource-Based Constrained Delegation (RBCD) Attack"
date: 2025-04-09 10:00:00 +0300
categories: [Active Directory, Privilege Escalation]
tags: [rbcd, kerberos, active-directory, penetration-testing, delegation, impacket, red-team]
description: "What is Resource-Based Constrained Delegation, how is it exploited, and a full end-to-end attack chain walk-through using my automation tool RBCD-Pwn."
---
...
bu içerik sence nasıl ilk blog post olacak, hata var mı 